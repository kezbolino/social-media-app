...
- ⭐ **Version bump (do automatically, never ask):** every shipped feature/
  ...
  committing. Increment the patch (v0.98 → v0.99). The one version source is that
...
- **v0.95** — Text-tool fonts re-matched closer to IG Story styles (5 OFL faces).
- **v0.94** — Text tool: fill-on by default for new text; removed the 🎯 eyedropper.
